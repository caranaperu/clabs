 ...
 *
 */
class ResponseProcessorAmchartsJson implements TSLIResponseProcessor {
...
// Procesamos la data
                ...
                if (isset($data)) {
                    ...
                    $out .= ',seriesTitles:[';
                    foreach ($data as $row) {
// el cambio de atleta indica un nuevo dataset.
                        if ($row['atletas_nombre_completo'] != $lastAtleta) {
                            $out .= $prefix . '"' . $row['atletas_nombre_completo'] . '"';
                            $prefix = ',';

                            $lastAtleta = $row['atletas_nombre_completo'];
                        }
                        $count++;
                    }
                    $out .= ']';
...
// el cambio de atleta indica un nuevo dataset.
                        ...
                        $out .= 'tipo:"' . $row['tipo'] . '",';
                        $out .= 'vflag:"' . $row['vflag'] . '",';
                        if(isset($row['rank_pos'])) {
                            $out .= 'rank_pos:"' . $row['rank_pos'] . '",';
                        }
