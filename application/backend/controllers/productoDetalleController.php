    ...
    protected function setupData() {
        ...
        $this->setupOpts = [
            ...
            "paramsList" => [
                ...
                "add" => ['insumo_id_origen','insumo_id','insumo_descripcion','unidad_medida_codigo','unidad_medida_descripcion','producto_detalle_cantidad','producto_detalle_merma', 'activo'],
                "del" => ['producto_detalle_id', 'versionId'],
                "upd" => ['producto_detalle_id','insumo_id_origen','insumo_id','insumo_descripcion','unidad_medida_codigo','unidad_medida_descripcion','producto_detalle_cantidad','producto_detalle_merma', 'versionId', 'activo'],
            ],
