    ...
    protected function setupData() {
        ...
        $this->setupOpts = [
            ...
            "paramsList" => [
                ...
                "add" => ['unidad_medida_codigo','unidad_medida_siglas', 'unidad_medida_descripcion', 'unidad_medida_tipo', 'activo'],
                "del" => ['unidad_medida_codigo', 'versionId'],
                "upd" => ['unidad_medida_codigo', 'unidad_medida_siglas','unidad_medida_descripcion', 'unidad_medida_tipo','versionId', 'activo'],
            ],
